...
export function EditCommunityClient({ slug }: { slug: string }) {
    ...
    const initialValues: Partial<CommunityFormValues> = {
        ...
        bedsMin: String(community.bedsMin),
        bedsMax: String(community.bedsMax),
        bathsMin: String(community.bathsMin),
        bathsMax: String(community.bathsMax),
        garageMin: String(community.garageMin),
        garageMax: String(community.garageMax),
        storiesMin: String(community.storiesMin),
        storiesMax: String(community.storiesMax),
        sqftFrom: String(community.sqftFrom),
        priceFrom: String(community.priceFrom),
